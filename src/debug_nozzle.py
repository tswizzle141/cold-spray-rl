...
def test_mass_conservation():
    ...
    # change here to prove mass conservation. just be careful: when L is too small;
    # with C or w/o C are similar. the difference will pose as we set L big enough
...
def visualize_small_L_footprint():
    ...
    dx = 1e-12 #change here to see the bump. it will not change when dx (or L, as dy=0) is too small
    dy = 0.0
    x1, y1 = x0 + dx, y0 + dy
